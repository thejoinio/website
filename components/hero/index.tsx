...
export default function Hero () {
    return (
      <section className="hero-section relative min-h-screen gap-4 font-[family-name:var(--font-geist-sans)] w-full mx-auto overflow-hidden pt-20 px-5 md:px-10 lg:px-20">
        <div className="flex flex-col gap-[72px] pt-[60px]">
          <div className="flex flex-col gap-[22px] relative hero-heading">
            <h1 className="text-2xl/normal xs:text-[40px]/normal md:text-[64px]/normal font-medium max-w-[18ch] mx-auto text-center">
              Experience J
              <Image
                src={joinToken}
        ...
        <p
          className={`absolute top-[170px] -left-8 md:-left-0 -z-10 text-xs font-medium uppercase text-[#6B7280] whitespace-nowrap -rotate-90 `}
        >
          Constant Reward
        </p>
        <p
          className={`absolute top-1/2 left-0 md:left-8 -z-10 text-xs font-medium uppercase text-[#6B7280] whitespace-nowrap -rotate-90`}
        >
          Social Life
        </p>
        <p
          className={`absolute bottom-24 left-0 md:left-8 -z-10 text-xs font-medium uppercase text-[#6B7280] whitespace-nowrap -rotate-90`}
        >
          Blockchain
        </p>
        <p
          className={`absolute bottom-44 -right-20 md:-right-8 -z-10 text-xs font-medium uppercase text-[#6B7280] whitespace-nowrap -rotate-90`}
        >
